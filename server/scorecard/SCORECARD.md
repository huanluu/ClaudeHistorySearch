...
- **Enforced by**: `tests/scorecard.test.ts` → `'ARCH-INV-5: Interface-Typed Module Boundaries'` (`it.fails`)
...
- **Enforced by**: `tests/scorecard.test.ts` → `'ARCH-INV-6: Test Existence Floor'` (`it.fails`)
