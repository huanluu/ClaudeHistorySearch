...
import type { SessionRepository } from '../src/shared/provider/index';
import type { SessionRecord, MessageRecord, SearchResultRecord } from '../src/shared/provider/index';
...
describe('GET /health (with diagnosticsService)', () => {
  const mockRepo = createMockRepository();
  ...
  it('should fall back to simple response without diagnosticsService', async () => {
    const app = createTestApp({ repo: mockRepo }, false);
