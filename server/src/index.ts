...
// Authentication middleware (stateless, safe to mount early)
transport.use(authMiddleware);

// Start server
async function main(): Promise<void> {
  // Initialize services before router so all deps are available upfront
  ...
  // Config change handler for hot reload
  ...
  // Create router with all dependencies wired upfront
  ...
  // Start server (router is fully wired before accepting requests)
