...
The assistant feature uses the GitHub Copilot SDK to provide real LLM conversations. The SDK **piggybacks on the local Copilot CLI authentication/runtime** — no separate API key needed. It spawns the Copilot runtime as a subprocess and streams responses.
...
### Session indexing source: GitHub Copilot CLI
